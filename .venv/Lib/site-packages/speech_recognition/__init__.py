...
class Recognizer(AudioSource):
    ...
    def recognize_google(self, audio_data, key=None, language="en-US", pfilter=0, show_all=False, with_confidence=False):
        ...
        if key is None: key = "AIXXXXXXXXXXXXXXXXXXXXXXXXXXXxXXXXXX"  # this is a generic key that works out of the box, but it may be revoked by Google at any time. For personal or testing purposes only.
